...
from . import base, deprecated, imageoperations
...
class RadiomicsFirstOrder(base.RadiomicsFeaturesBase):
  ...
  def __init__(self, inputImage, inputMask, store_path, **kwargs):
  ...
  def _initCalculation(self):
    ...
    numpy.save(self.store_path + '\\' + 'targetVoxelArray.npy', self.targetVoxelArray)
